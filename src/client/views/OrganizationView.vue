...
<template>
  <div class="organization-view" v-loading="loading">
    ...
    <el-dialog append-to-body v-model="createOrganizationDialog" align-center class="envman-dialog compact-dialog" :title="$t('创建新组织')" width="500px">
    ...
    <el-dialog append-to-body v-model="joinOrganizationDialog" align-center class="envman-dialog compact-dialog" :title="$t('通过邀请链接加入组织')" width="540px" @closed="invitationLinkInput = ''">
    ...
    <el-dialog append-to-body v-model="projectDialog" align-center class="envman-dialog compact-dialog" :title="projectDialogMode === 'create' ? $t('创建项目组') : $t('编辑项目组')" width="520px">
    ...
    <el-dialog append-to-body v-model="invitationUsersDialog" align-center class="envman-dialog compact-dialog operation-dialog invitation-users-dialog" :title="$t('通过链接加入的用户')" width="min(620px, calc(100% - 32px))">
