...
describe("professional connection editor capabilities", () => {
  ...
  it.each([
    ...
    expect(contents).toContain('value: "sshAgent"');
    ...
    expect(contents).toContain("connectTimeoutSeconds: form.connectTimeoutSeconds");
    expect(contents).toContain("proxyType: form.proxyType");
    expect(contents).toContain("credential.proxyPassword = form.proxyPassword");
    expect(contents).toContain("ipVersion: form.ipVersion");
    expect(contents).toContain("algorithmPreset: form.algorithmPreset");
    expect(contents).toContain("agentForwarding: form.agentForwarding");
    expect(contents).toContain("compression: form.compression");
